...
This repository is maintained as a **dataset ingestion and poisoning-screening service**.

## Production purpose

screen batch/streaming datasets, isolate suspicious samples, persist evidence, and expose operational metrics.

## Release gate

A release is promotable only when unit/integration tests, API/stream behavior, security checks, and benchmark regressions pass.
